...
class _BookingConfirmScreenState extends State<BookingConfirmScreen> {
  ...
  bool _isStart(int day) {
    ...
    final d = DateTime(_viewYear, _viewMonth, day);
    return d.year == _checkIn!.year &&
        d.month == _checkIn!.month &&
        d.day == _checkIn!.day;
  }
  ...
  bool _isEnd(int day) {
    ...
    final d = DateTime(_viewYear, _viewMonth, day);
    return d.year == _checkOut!.year &&
        d.month == _checkOut!.month &&
        d.day == _checkOut!.day;
  }
  ...
  double get _roomPrice =>
      _room?.pricePerNight ?? _property?.pricePerNight ?? 0.0;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: AppSpacing.md),
        _BillingRow(
            label: '${formatVnd(roomPrice)} x $nights đêm',
        ...
        Row(
          ...
          children: [
            Text('Tổng thanh toán',
                style: AppTextStyles.titleLg.copyWith(
                    color: AppColors.primary, fontWeight: FontWeight.w600)),
            Text(formatVnd(nights > 0 ? total : 0.0),
...
class _BookingSuccessDialog extends StatelessWidget {
  ...
  const _BookingSuccessDialog(
      {required this.propertyName, required this.onClose});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Chuyến đi của bạn tại $propertyName đã được xác nhận.',
                textAlign: TextAlign.center,
                style: AppTextStyles.bodyMd
                    .copyWith(color: AppColors.onSurfaceVariant)),
